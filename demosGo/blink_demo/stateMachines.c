...
void buzzer_state_3_advance(){
  ...
  switch(buzz_state) {
   case 0: buzzer_set_period(14431); red_on = 1; green_on = 1; buzz_state++; break;
   case 1: buzzer_set_period(0); red_on = 0; green_on = 0; buzz_state++; break;
   case 2: buzzer_set_period(14431); red_on = 1; green_on = 1; buzz_state++; break;
...
void buzzer_state_4_advance(){
  static char buzz_state = 0 ;
  switch(buzz_state) {
   case 0: buzzer_set_period(16198); red_on = 1; green_on = 0; buzz_state++; break;
  case 1: buzzer_set_period(12139); red_on = 0; green_on = 1; buzz_state++; break;
   case 2: buzzer_set_period(0); red_on = 0; green_on = 0; buzz_state++; break;// Pause      
